...
export const YOUTUBE_COMMENTS_API = "https://www.googleapis.com/youtube/v3/commentThreads?key=[YOUR_API_KEY]&textFormat=plainText&part=snippet%2Creplies&videoId=[VIDEO_ID]&maxResults=100";
